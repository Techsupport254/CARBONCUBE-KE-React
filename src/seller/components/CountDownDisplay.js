...
const CountDownDisplay = () => {
		...
		return (
			<div className="text-center">
				<div className="flex justify-center mb-3">
					<FontAwesomeIcon
						icon={tierInfo.icon}
						className={`w-12 h-12 ${tierInfo.color}`}
					/>
				</div>
				<div className={`text-2xl font-bold ${tierInfo.color} mb-2`}>
					{tierInfo.name}
				</div>
	...
	if (daysLeft <= 0) {
		...
		return (
			<div className="text-center">
				...
				<div className="text-sm text-gray-600">Subscription Expired</div>
			</div>
		);
	}
	...
	return (
		<div className="text-center">
			...
			<div className={`text-xl font-bold ${tierInfo.color} mb-2`}>
				{tierInfo.name}
			</div>
			<div className={`text-3xl font-bold ${tierInfo.color} mb-1`}>
				{countdown.days}
			</div>
			<div className="text-sm text-gray-600 mb-3">Days Left</div>
