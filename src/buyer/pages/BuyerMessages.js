...
const BuyerMessages = () => {
	...
	const fetchMessages = async (conversationId) => {
		...
		try {
			const response = await fetch(
				`${process.env.REACT_APP_BACKEND_URL}/buyer/conversations/${conversationId}/messages`,
				{
					headers: {
						Authorization: "Bearer " + sessionStorage.getItem("token"),
					},
	...
	const handleSendMessage = async (e) => {
		...
		try {
			const response = await fetch(
				`${process.env.REACT_APP_BACKEND_URL}/buyer/conversations/${selectedConversation.id}/messages`,
				{
					method: "POST",
					headers: {
