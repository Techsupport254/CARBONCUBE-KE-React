...
const Banner = () => {
	...
	useEffect(() => {
		// For now, use fallback images directly
	...
	return (
		<div className="w-full max-w-7xl mx-auto text-center overflow-hidden relative z-1">
			{isLoading ? (
						...
						<Carousel.Item key={index}>
							<div className="w-full relative">
								...
								{index === images.length - 1 && premiumAds.length > 0 && (
									<div className="flex justify-center items-center gap-2 sm:gap-4 md:gap-6 lg:gap-8 absolute z-10 w-full top-[10%] px-2 sm:px-4 md:px-6 lg:px-8">
