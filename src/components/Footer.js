...
const Footer = () => (
	<footer
		className="mt-5 text-white overflow-hidden footer-container"
	...
	>
		...
		<div className="position-absolute top-0 start-0 w-100 h-100 opacity-5">
			<div
				style={{
					background:
						"repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,193,7,.1) 35px, rgba(255,193,7,.1) 70px)",
					width: "100%",
					height: "100%",
				}}
			></div>
