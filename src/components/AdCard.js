		...
		>
			...
			{variant === "best-seller" && (
				<div
					...
					} px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 whitespace-nowrap z-10 shadow-sm`}
				>
					Best Seller
				</div>
			)}
			...
			{variant === "featured" && (
				<div className="absolute top-1 right-1 px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 whitespace-nowrap z-10 shadow-sm">
					Featured
				</div>
			)}
