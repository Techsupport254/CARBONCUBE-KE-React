...
const SellerAgeGroupChart = ({ data }) => {
	if (!data || typeof data !== "object") {
		return (
			<div className="text-center">No seller age group data available</div>
		);
	}
	...
	if (!data || typeof data !== "object") {
		return (
			<div className="text-center">
				No seller gender distribution data available
			</div>
		);
	}
...
const SellerCategoryChart = ({ data }) => {
	if (!data || !Array.isArray(data)) {
		return <div className="text-center">No seller category data available</div>;
	}
...
const SellerTierChart = ({ data }) => {
	if (!data || !Array.isArray(data)) {
		return <div className="text-center">No seller tier data available</div>;
	}
